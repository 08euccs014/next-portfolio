  ...
  const skillCategories = [
    {
      ...
      skills: [
        { name: "Agentic AI", level: 93, description: "Tool-calling agents, memory, and multi-step orchestration" },
        { name: "LangChain", level: 95, description: "Building conversational AI applications" },
        { name: "Observability", level: 88, description: "Tracing, evals, and monitoring for LLM applications" },
        ...
        { name: "Vector Databases", level: 90, description: "Pinecone, PGVector, and embedding stores for RAG" },
        { name: "Pinecone", level: 88, description: "Managed vector search for RAG and semantic retrieval" },
        { name: "PGVector", level: 87, description: "Vector similarity search on PostgreSQL" },
        { name: "PostgreSQL", level: 88, description: "Relational data for AI application backends" },
        { name: "AWS RDS", level: 85, description: "Managed Postgres for production AI services" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Supabase", level: 88, description: "Postgres, auth, storage, and realtime" },
        { name: "PostgreSQL", level: 85, description: "Relational database" },
        { name: "AWS RDS", level: 85, description: "Managed relational databases" },
        { name: "PGVector", level: 87, description: "Postgres vector search" },
        { name: "Pinecone", level: 88, description: "Managed vector database" },
