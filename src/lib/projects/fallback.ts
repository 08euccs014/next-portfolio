...
export const FALLBACK_PROJECTS: Project[] = [
  {
    ...
    tech_groups: [{"label": "App", "items": ["React", "Next.js"]}, {"label": "AI", "items": ["AI image editing", "Image processing"]}, {"label": "Data", "items": ["PostgreSQL", "AWS RDS", "Vector database"]}],
  ...
  },
  {
    ...
    tech_groups: [{"label": "Mobile", "items": ["React Native", "React Native Paper"]}, {"label": "Web", "items": ["Next.js", "Redux Toolkit", "Tailwind CSS"]}, {"label": "Backend", "items": ["Node.js", "Express", "AWS Lambda", "DocumentDB", "S3", "Rekognition"]}, {"label": "AI", "items": ["Vector database", "Pinecone", "PGVector"]}],
  ...
  },
  {
    ...
    tech_groups: [{"label": "AI", "items": ["Python", "Google Vision OCR", "GPT-4", "Vector database", "Pinecone", "PGVector"]}, {"label": "App", "items": ["FastAPI", "React", "Node.js", "PostgreSQL", "AWS RDS"]}],
  ...
  },
  {
    ...
    tech_groups: [{"label": "AI", "items": ["LangChain", "LangGraph", "LangFuse", "Gemini", "OpenAI", "Vector database", "Pinecone", "PGVector"]}, {"label": "App", "items": ["React Native", "Next.js", "FastAPI", "Node.js", "WebSocket"]}, {"label": "Data", "items": ["PostgreSQL", "AWS RDS", "MongoDB", "Stripe"]}],
  ...
  },
  {
    ...
    tech_groups: [{"label": "App", "items": ["React", "React Native", "Node.js", "PostgreSQL", "AWS RDS"]}, {"label": "AI", "items": ["Python", "LangChain", "LLMs", "Vector database", "Pinecone", "PGVector"]}],
  ...
  },
  {
    ...
    tech_groups: [{"label": "AI", "items": ["Python", "Claude Sonnet 3.5", "OpenAI", "NLP", "Vector database", "Pinecone", "PGVector"]}, {"label": "Cloud", "items": ["AWS Lambda", "SQS", "Step Functions", "DynamoDB", "PostgreSQL", "AWS RDS"]}],
